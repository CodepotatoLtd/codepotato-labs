<x-jet-action-section>
    <x-slot name="title">
        <span class="text-white">{{ __('Browser Sessions') }}</span>
    </x-slot>

    <x-slot name="description">
        <span class="text-white opacity-75">{{ __('Manage and logout your active sessions on other browsers and devices.') }}</span>
    </x-slot>
