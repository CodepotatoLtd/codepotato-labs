            ...
            <div class="mb-6">
                <div class="flex flex-row items-center justify-between p-4">
                    <div class="flex flex-col w-1/2">
                        <a wire:click="navigateTo({{ $idea->getKey() }})"
                           class="cursor-pointer text-5xl font-bold tracking-wide text-gradient bg-gradient-to-r from-cp-pink to-cp-purple">{{ $idea->title }}</a>
                    </div>
                    <div>
                        <div
                            class="flex mr-4 rounded-md inline-flex pr-4 flex-row bg-cp-purple items-center uppercase text-xs tracking-wide font-semibold">
                        ...
                        <div
                            class="flex mr-4 rounded-md inline-flex pr-4 flex-row bg-cp-blue text-cp-dark-blue items-center uppercase text-xs tracking-wide font-semibold">
