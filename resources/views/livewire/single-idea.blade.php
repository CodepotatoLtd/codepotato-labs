<div class="py-12">
    ...
    <p class="text-2xl mb-3 text-blue-200 opacity-50 hover:opacity-100">Oooh, wouldn't it be fab if a <a href="{{ route('product.show', [$idea->product]) }}" class="text-cp-pink">{{ $idea->product->name }}</a> had...</p>
    ...
    <div class="mt-6 flex rounded-md inline-flex pr-4 flex-row bg-cp-purple items-center uppercase text-xs tracking-wide font-semibold">
